/**
 * @file AWD_LoRa_Node3_V6.ino
 * @brief LoRa Slave Transmitter — T22D(Lora3)
 * @version V6
 *
 * ===================== FIX LIST V6 =====================
 ...
 *         Stagger: 480s offset from power-on.
 *
...
#define DEVICE_ID       "T22D(Lora3)"
#define DEVICE_NUMBER   3   // 1-5
...
#define DEVICE_STAGGER_SEC  480UL
...
const char* AP_SSID = "LoRaTX-Lora3-Setup";
