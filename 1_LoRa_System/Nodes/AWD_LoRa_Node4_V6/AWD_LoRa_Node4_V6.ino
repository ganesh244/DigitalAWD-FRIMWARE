/**
 * @file AWD_LoRa_Node4_V6.ino
 * @brief LoRa Slave Transmitter — T22D(Lora4)
 * @version V6
 *
 * ===================== FIX LIST V6 =====================
 ...
 *         Stagger: 720s offset from power-on.
 *
...
#define DEVICE_ID       "T22D(Lora4)"
#define DEVICE_NUMBER   4   // 1-5
...
#define DEVICE_STAGGER_SEC  720UL
...
const char* AP_SSID = "LoRaTX-Lora4-Setup";
