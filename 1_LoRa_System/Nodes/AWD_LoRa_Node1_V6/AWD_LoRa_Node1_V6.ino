/**
 * @file AWD_LoRa_Node1_V6.ino
 * @brief LoRa Slave Transmitter — T22D(Lora1)
 * @version V6
 *
 * ===================== FIX LIST V6 =====================
 ...
 *         Stagger: 0s offset from power-on.
 *
...
#define DEVICE_ID       "T22D(Lora1)"
#define DEVICE_NUMBER   1   // 1-5
...
const char* AP_SSID = "LoRaTX-Lora1-Setup";
