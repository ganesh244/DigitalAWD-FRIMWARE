/**
 * @file AWD_LoRa_Node2_V6.ino
 * @brief LoRa Slave Transmitter — T22D(Lora2)
 * @version V6
 *
 * ===================== FIX LIST V6 =====================
 ...
 *         Stagger: 240s offset from power-on.
 *
...
#define DEVICE_STAGGER_SEC  240UL
...
const char* AP_SSID = "LoRaTX-Lora2-Setup";
